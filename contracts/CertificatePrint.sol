...
contract CertificatePrint is Issuers {
    ...
    function printCertificate (string _name, string _email, bytes32 _institution, string _course, string _dates, uint16 _hours) public onlyInstitution(_institution) returns (bytes32 certificateAddress) {
    ...
    modifier onlyCertificateIssuer(bytes32 _certificateAddress) {
        ...
        checkRole(msg.sender, institutionsAccessRights[institution]);
        _;
    }
}
